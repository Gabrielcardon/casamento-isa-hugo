    ...
    <section id="local" className="relative overflow-hidden bg-cream px-6 pb-16 pt-10 md:px-10 md:pb-20 md:pt-14">
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="mt-5 inline-flex items-center gap-2 font-sans text-sm font-medium tracking-wide text-[#170909] underline decoration-[#170909]/60 decoration-2 underline-offset-4 transition-colors hover:text-coral hover:decoration-coral"
        >
